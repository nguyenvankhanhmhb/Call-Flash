package com.basic.common.widget.image;
...
public class PorterShapeImageView extends PorterImageView {
    ...
    private void setup(Context context, AttributeSet attrs, int defStyle) {
        if (attrs != null) {
            @SuppressLint("CustomViewStyleable") TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.PorterImageView, defStyle, 0);
            shape = typedArray.getDrawable(R.styleable.PorterImageView_frameSrc);
            typedArray.recycle();
        }
        matrix = new Matrix();
    }
    ...
    public void changeShape(Context context, Integer drawable) {
        shape = context.getDrawable(drawable);
    }
