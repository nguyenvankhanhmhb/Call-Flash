package com.basic.common.widget.bouncy
...
import com.basic.common.widget.bouncy.util.Bouncy
import com.basic.common.widget.bouncy.util.BouncyEdgeEffect
import com.widget.R
    ...
    init {
        ...
        context.theme.obtainStyledAttributes(attrs, R.styleable.BouncyNestedScrollView, 0, 0)
            .apply {
                ...
                when (getInt(
                    R.styleable.BouncyNestedScrollView_bouncy_scrollview_damping_ratio,
                    0
                )) {
